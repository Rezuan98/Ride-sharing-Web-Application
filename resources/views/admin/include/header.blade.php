      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           <img style="border:3px solid orange" class="wd-45 ht-40 rounded-circle" src="{{  asset('images/userimages/' . $data->image)  }}" alt="profile"> 
          </a>
          ...
          <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
            <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
              <div class="mb-3">
               <img style="border:3px solid orange" class="wd-80 ht-80 rounded-circle" src="{{ asset('images/userimages/' . $data->image)   }}" alt="profile"> 
              </div>
