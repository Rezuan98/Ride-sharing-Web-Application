...
<div class="col-md-3 p-0">
    <div class="card">
        ...
        <!-- Main Body -->
        <div class="col-md-9 mt-3" style="background-color: rgb(240, 245,250)">
            <div class="card">
                            ...
                            <tbody>
                                 ...
                                 @foreach($bookings as $key => $booking)  
                                    <tr>
                                        ...
                                        <td>{{ $passengers[$key]->name }}</td> <!-- Access passenger details based on the current index -->
                                        <td>{{ $passengers[$key]->phone }}</td> <!-- Access passenger details based on the current index -->
